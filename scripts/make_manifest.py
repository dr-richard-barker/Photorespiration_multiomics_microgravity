...
DESCRIBED = {
 ...
 "T08_paintomics_significant.tsv": ("scripts/06_paintomics_tables.py (job m1z16Qg3DK)",
   "All 32 pathways significant at combined Fisher p < 0.05, with per-omic p-values",
   "results/paintomics_raw/job1_m1z16Qg3DK_full.json.gz"),
 "T09_paintomics_carbon.tsv": ("scripts/06_paintomics_tables.py (job m1z16Qg3DK)",
   "The carbon pathways the model made claims about, significant or not",
   "results/paintomics_raw/job1_m1z16Qg3DK_full.json.gz"),
 "T10_metabolite_hubs.tsv": ("scripts/06_paintomics_tables.py (job m1z16Qg3DK)",
